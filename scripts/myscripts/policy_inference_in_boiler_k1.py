...
from isaaclab_tasks.manager_based.locomotion.velocity.config.booster_k1.rough_env_cfg import BoosterK1RoughEnvCfg_PLAY
...
def main():
    ...
    # setup environment
    env_cfg = BoosterK1RoughEnvCfg_PLAY()
